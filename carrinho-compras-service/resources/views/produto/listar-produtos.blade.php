                    ...
                    <a href="{{ route('produtos.show', ['id' => $produto['id']]) }}" style="text-decoration: none;">
                        <div class="card card-produtos card-hover card-wide">
                            <div class="ratio ratio-4x3">
                                <img src="{{ $produto['imagem_link'] }}" class="card-img-top img-fluid object-fit-contain"
                                    alt="Foto do produto">
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h5 class="card-title fs-5">{{ $produto['nome'] }}</h5>
                                </div>
                                <div class="small mb-2">
                                    <p class="card-text"><small>{{ $produto['descricao'] }}</small></p>
                                    <h6 class="card-text fs-6">R$ {{ $produto['valor'] }}</h6>

                                    <img src="{{ asset('imagens/star.png') }}" style="width: 14px;"><img
                                        src="{{ asset('imagens/star.png') }}" style="width: 14px;"><img
                                        src="{{ asset('imagens/star.png') }}" style="width: 14px;"><img
                                        src="{{ asset('imagens/star.png') }}" style="width: 14px;"><img
                                        src="{{ asset('imagens/star.png') }}" style="width: 14px;"> 4.5 (123)
                                </div>
